 ...
 *  @note Se a alocação falhar, chama fatal_error_no_memory() e encerra o programa.
 */
void* xmalloc(size_t t);

/** @brief Wrapper para a função realloc com verificação de erro.
 *  @param p Ponteiro para o endereço na memória onde será iniciada a realocação.
 *  @param t Tamanho em bytes a ser realocado.
 *  @return Um ponteiro para a memória realocada.
 *  @note Se a realocação falhar, chama fatal_error_no_memory() e encerra o programa.
 */
