...
public:
  ...
  { 
    std::vector<std::tuple<TokenClass, std::string, unsigned int>> tups_tokcls_str_uint = {
      ...
      // bellow are bit size specified cases
      {NUM_BASE_BINARY, "1'b0", 0},
      {NUM_BASE_BINARY, "1'b1", 1},
      {NUM_BASE_BINARY, "2'b00", 0},
      {NUM_BASE_BINARY, "2'b01", 1},
      {NUM_BASE_BINARY, "2'b10", 2},
      {NUM_BASE_BINARY, "8'b10101010", 170},
      {NUM_BASE_BINARY, "10'b1010101010", 682},
      {NUM_BASE_BINARY, "16'b1010101010101010", 43690},
      {NUM_BASE_BINARY, "16'b1010101_010101010", 43690},
      {NUM_BASE_HEX,    "4'h0", 0},
      {NUM_BASE_HEX,    "4'h1", 1},
      {NUM_BASE_HEX,    "4'hF", 15},
      {NUM_BASE_HEX,    "16'hBABA", 47802},
      {NUM_BASE_HEX,    "32'hDEADBEEF", 3735928559},
      {NUM_BASE_HEX,    "32'hDEAD_BEEF", 3735928559},
      {NUM_BASE_OCTAL,  "3'o0", 0},
      {NUM_BASE_OCTAL,  "3'o1", 1},
      {NUM_BASE_OCTAL,  "3'o7", 7},
      {NUM_BASE_OCTAL,  "6'o77", 63},
      {NUM_BASE_OCTAL,  "9'o770", 504},
      {NUM_BASE_OCTAL,  "12'o7701", 4033},
      {NUM_BASE_OCTAL,  "18'o770155", 258157},
      {NUM_BASE_OCTAL,  "18'o77_01_55", 258157},
      {NUM_BASE_OCTAL,  "36'o770155770155", 67674566765},
      // bellow are the same cases as above but with only the ' prefix:
      {NUM_BASE_BINARY, "'b0", 0},
      {NUM_BASE_BINARY, "'b1", 1},
      {NUM_BASE_BINARY, "'b00", 0},
      {NUM_BASE_BINARY, "'b01", 1},
      {NUM_BASE_BINARY, "'b10", 2},
      {NUM_BASE_BINARY, "'b10101010", 170},
      {NUM_BASE_BINARY, "'b1010101010", 682},
      {NUM_BASE_BINARY, "'b1010101010101010", 43690},
      {NUM_BASE_BINARY, "'b1010101_010101010", 43690},
      {NUM_BASE_HEX,    "'h0", 0},
      {NUM_BASE_HEX,    "'h1", 1},
      {NUM_BASE_HEX,    "'hF", 15},
      {NUM_BASE_HEX,    "'hBABA", 47802},
      {NUM_BASE_HEX,    "'hDEADBEEF", 3735928559},
      {NUM_BASE_HEX,    "'hDEAD_BEEF", 3735928559},
      {NUM_BASE_OCTAL,  "'o0", 0},
      {NUM_BASE_OCTAL,  "'o1", 1},
      {NUM_BASE_OCTAL,  "'o7", 7},
      {NUM_BASE_OCTAL,  "'o77", 63},
      {NUM_BASE_OCTAL,  "'o770", 504},
      {NUM_BASE_OCTAL,  "'o7701", 4033},
      {NUM_BASE_OCTAL,  "'o770155", 258157},
      {NUM_BASE_OCTAL,  "'o77_01_55", 258157},
      {NUM_BASE_OCTAL,  "'o770155770155", 67674566765}
    };
