...
ACLOCAL = ${SHELL} ./missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} ./missing autoconf
AUTOHEADER = ${SHELL} ./missing autoheader
AUTOMAKE = ${SHELL} ./missing automake-1.15
AWK = gawk
CC = gcc
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} ./missing makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = progres
...
install_sh = ${SHELL} /home/tiago/projetos/progres/install-sh
